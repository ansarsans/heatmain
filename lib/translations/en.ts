export const en: Record<string, string> = {
  ...
  "products.specification.width": "Width, mm",
  "products.specification.supplier": "Supplier",
  ...
  "catalog.subtitle": "Full range of chemical reagents, metals, rubber products, and equipment",
  ...
  "catalog.list.equipment": "Equipment, components & consumables list",
  "catalog.list.rubber": "Rubber products list",
  "catalog.all": "All",
  "catalog.chemistry": "Chemical Reagents",
  "catalog.metals": "Metals & Alloys",
  "catalog.equipment": "Equipment, Components & Consumables",
  "catalog.rubber": "Rubber Products",
  ...
  "contacts.form_hint": "Enter your full name, a message, and at least one contact: phone or email.",
  "contacts.prefill_product": "Product inquiry (id)",
  "contacts.full_name_label": "Full name",
  "contacts.phone_label": "Your phone",
  "contacts.phone_placeholder": "+7 701 773 44 44",
  ...
  "privacy.form.required": "I consent to Heat Energy Capital LLP (BIN 240240013512) collecting and processing my personal data in accordance with the",
